...
void control_window::on_open_device_clicked()
{
    ...
    //设置曝光时间
    qDebug()<<"SetExposureTime:"<<m_pcMyCamera->SetFloatValue("ExposureTime",50000);
...
// removed: separate stop handler merged into on_continuous_acquisition_clicked


// note: on_save_BMP_clicked and on_save_PNG_clicked removed; save handled by save_formal combobox
